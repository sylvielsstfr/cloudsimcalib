...
Altitude = 0.  # in kilo meters
OBS_Altitude = str(Altitude)

TOPDIR='simulations/RT/2.0.1/MPL'
...
#------------------------------------------------------------------------------
def ProcessSimulationaer(airmass_num,pwv_num,oz_num,aer_num,press_num,prof_str='us',proc_str='sa',cloudext=0.):
    """
...
#   Selection of absorption model 
    ...
    for atmosphere in theatmospheres:
        ...
        uvspec.inp["wavelength"]       = '2500.0 100000.0'
        #uvspec.inp["output_quantity"] = 'brightness'
        uvspec.inp["output_process"] = "per_nm"
#       uvspec.inp["verbose"] = ''
        uvspec.inp["quiet"] = ''
...
if __name__ == "__main__":
    ...
    if AerosolTest_Flag==False:
        try:
            opts, args = getopt.getopt(sys.argv[1:],"hz:w:o:p:m:",["z=","w=","o=","p=","m=","c="])
        except getopt.GetoptError:
            print(' Exception bad getopt with :: '+sys.argv[0]+ ' -z <airmass> -w <pwv> -o <oz> -p <press> -m <model> -c<opt-depth>')
            sys.exit(2)
        ...
        path, outputfile=ProcessSimulation(airmass_nb,pwv_nb,oz_nb,press_nb,model_str,cloud_nb)
